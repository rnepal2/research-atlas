...
export function PageHeader({ title, description, eyebrow, actions, actionsClassName }: PageHeaderProps) {
  return (
    <section className="flex min-w-0 items-center justify-between gap-6 border-b border-border/70 pb-[18px] max-[760px]:flex-col max-[760px]:items-stretch max-[760px]:gap-3.5 max-[760px]:pb-4">
      <div className="min-w-0">
        ...
        <p className="mt-2 mb-0 max-w-[740px] text-[0.83rem] leading-[1.5] text-muted-foreground [overflow-wrap:anywhere]">{description}</p>
      </div>
