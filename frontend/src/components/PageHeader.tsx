...
export function PageHeader({ title, description, eyebrow, actions, actionsClassName }: PageHeaderProps) {
  return (
    <section className="flex min-w-0 items-start justify-between gap-4 max-[760px]:flex-col max-[760px]:items-stretch">
      <div className="min-w-0">
        ...
        <p className="mt-1.5 mb-0 max-w-[760px] text-[0.83rem] leading-[1.45] text-muted-foreground [overflow-wrap:anywhere]">{description}</p>
      </div>
